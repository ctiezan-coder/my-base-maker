-- Corriger la politique SELECT pour media_content
-- Les utilisateurs de la direction "Communication" doivent voir TOUS les médias
...
FOR SELECT
USING (
  -- Les utilisateurs de la direction Communication voient tous les médias
  (EXISTS (
